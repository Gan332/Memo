...
class $ChecklistItemsTable extends ChecklistItems
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, noteId, itemText, isCompleted, sortOrder];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class ChecklistItem extends DataClass implements Insertable<ChecklistItem> {
  ...
  @override
  int get hashCode => Object.hash(id, noteId, itemText, isCompleted, sortOrder);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
  ...
  static MultiTypedResultKey<$ChecklistItemsTable, List<ChecklistItem>>
      _checklistItemsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.checklistItems,
              aliasName:
                  $_aliasNameGenerator(db.notes.id, db.checklistItems.noteId));
...
class $$NotesTableTableManager extends RootTableManager<
    ...
    Note,
    PrefetchHooks Function({bool noteTagsRefs, bool checklistItemsRefs})> {
  $$NotesTableTableManager(_$AppDatabase db, $NotesTable table)
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              {noteTagsRefs = false, checklistItemsRefs = false}) {
...
final class $$ChecklistItemsTableReferences
  ...
  static $NotesTable _noteIdTable(_$AppDatabase db) => db.notes
      .createAlias($_aliasNameGenerator(db.checklistItems.noteId, db.notes.id));
